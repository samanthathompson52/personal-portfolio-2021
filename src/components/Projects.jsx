  ...
  return (
    ...
    <div className = 'section'>
      ...
      <div>
        ...
        <div className="col-sm-4"> 
          <div className = "project-files">
            <a href="https://github.com/samanthathompson52/discord-bot" target="_blank" rel="noopener noreferrer"><img src={pediatrics} width = "60%" alt="Link to Github for Pediatrics Website" /></a>
          </div>  
          </div>  
        </div>
        </div>  
