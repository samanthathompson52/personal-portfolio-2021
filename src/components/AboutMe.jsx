        ...
        <Container fluid className="border-line py-4">
          <Row>    
            ...
            <Col xs={12} md={8} lg={9} className="d-flex align-items-start">
              <div className = "px-4">
                <h4>About Me</h4>
                <h5>Neurobiology & Physiology graduate turned software developer. </h5>
                ...
                <h5>I discovered that I loved programming and began teaching myself everything I could! Since graduation, I dedicated my time to learning even more about the growing technologies of the world.</h5>
